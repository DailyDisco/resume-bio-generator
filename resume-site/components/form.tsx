    ...
    <>
      <div className='mb-6'>
        <p className='text-blue-500'>
          Enter a few words that you would throw into a bio. Like... "MERN
          Stack, Python, Amazon Web Services, Machine Learning, AI, hardworking,
          dedicated."
        </p>
        <div />
        <p className='text-red-700 mt-6'>
          Make sure to end your entry with a period '.'
        </p>
      </div>
      <input
        className='p-2 w-full rounded-md focus:outline-teal-400 focus:outline text-slate-700'
        type='text'
        placeholder='MERN Stack, Python, Amazon Web Services...'
        value={props.prompt}
      ...
      <button
        className='bg-gradient-to-r from-blue-400 to-purple-500 disabled:opacity-50 w-full p-2 rounded-md text-lg'
